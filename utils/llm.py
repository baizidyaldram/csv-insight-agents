...
# Free-tier models on OpenRouter (ranked by quality)
FREE_MODELS = [
...
def call_llm(prompt: str, system: str = "", model_index: int = 0, max_tokens: int = 1500) -> str:
    ...
    api_key = get_api_key()
    if not api_key:
        return "❌ OPENROUTER_API_KEY not found. Add it to your .env file or Streamlit secrets."
    ...
    try:
        ...
        return "❌ Request timed out. Try again or switch to a different model."
